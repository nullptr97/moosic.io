...
public protocol MoosicIOAuthorizatorDelegate: AnyObject {
    ...
    /// parameter sessionId: MoosicIO session identifier
    func tokenCreated(for sessionId: String, info: [String: String])
    ...
    func tokenUpdated(for sessionId: String, info: [String: String])
...
extension MoosicIOSessionDelegate {
    ...
    public func tokenCreated(for sessionId: String, info: [String: String]) {}
    public func tokenUpdated(for sessionId: String, info: [String: String]) {}
