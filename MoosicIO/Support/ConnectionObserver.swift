...
internal final class ConnectionObserverImpl: ConnectionObserver {
    ...
    private let appStateCenter: MoosicNotificationCenter
    private let reachabilityCenter: MoosicNotificationCenter
    private let reachability: MoosicReachability
    ...
    init(
        appStateCenter: MoosicNotificationCenter,
        reachabilityCenter: MoosicNotificationCenter,
        reachability: MoosicReachability,
